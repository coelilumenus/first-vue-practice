  ...
  <form class="card auth-card" @submit.prevent="submitHandler">
    <div class="card-content">
      ...
      <div class="input-field">
        ...
        <small class="helper-text invalid" v-else-if="$v.password.$dirty && !$v.password.minLength">{{'minLengthPassword' | localize}} {{$v.password.$params.minLength.min}} {{'symbols' | localize}}</small>
      </div>
    </div>
